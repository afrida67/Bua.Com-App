...
public class newBuaList extends AppCompatActivity {
...
TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_bua_list);
        setTitle("Full Timer Bua List");
     ...
     // String url = "http://cherry67.netne.net/aesha/fullbuaList.php";
        String url = "https://buacom.000webhostapp.com/aesha/fullbuaList.php";
                    ...
                    public void onResponse(String jsonText) {
                        ...
                        dictionary.addStringField(R.id.tvName, new StringExtractor<Product>() {
                            ...
                            public void onClick(Product item, int position, View view) {
                                Intent in = new Intent(newBuaList.this, SubActivity.class);
                                startActivity(in);
                            }
                        });
                      ...
                      /* dictionary.addStringField(R.id.tvPrice, new StringExtractor<Product>() {
                        ...
                        lvProduct.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                Intent in = new Intent(newBuaList.this, newDetail.class);
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(newBuaList.this, MainActivity.class);
