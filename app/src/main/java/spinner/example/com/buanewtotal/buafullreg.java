...
public class buafullreg extends AppCompatActivity implements View.OnClickListener {
   ...
   // private String UPLOAD_URL = "http://cherry67.netne.net/aesha/buafullreg.php";
    private String UPLOAD_URL = "https://buacom.000webhostapp.com/aesha/buafullreg.php";
    ...
    private String KEY_cook = "salary";
    private String KEY_ref = "ref";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_buafullreg);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        Toast.makeText(buafullreg.this, s, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        //Showing toast
                        Toast.makeText(buafullreg.this, volleyError.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
